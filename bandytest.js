var numbers = require('./testmodul3');                            // Получаем массив с числами
console.log(numbers.num);                         // Просматриваем 
if (numbers.num.length <= 1) {
   console.log('Недастаточно данных, для осуществления операции!')  // Проверяем, достаточно, ли чисел в массиве
} else {
